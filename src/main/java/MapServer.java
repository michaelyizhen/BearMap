...
public class MapServer {
    ...
    public static List<String> getLocationsByPrefix(String prefix) {
        Iterable<Location> iterable = graph.locationTrieST.keysWithPrefix(prefix);
        List<String> results = new ArrayList<>();
        for (Location lo : iterable) {
            results.add(lo.getName());
        }
        return results;
    }
    ...
    public static List<Map<String, Object>> getLocations(String locationName) {
        ...
        Iterable<Location> locations = graph.locationTrieST.keysThatMatch(locationName);
        List<Map<String, Object>> results = new LinkedList<>();
        for (Location location : locations) {
            Map<String, Object> node = new HashMap<>();
            node.put("name", location.getName());
            node.put("id", location.getId());
            node.put("lon", location.getLon());
            node.put("lat", location.getLat());
            results.add(node);
        }
        return results;
    }
